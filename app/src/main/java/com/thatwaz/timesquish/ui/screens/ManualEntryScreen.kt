...
fun ManualEntryScreen(
    ...
    val initialLabel = remember(entryToEdit) { entryToEdit?.label ?: "" }
    ...
    Column(
        ...
        OutlinedButton(
            onClick = {
                showDatePicker(context, startDateTime.toLocalDate()) { selectedDate ->
        ...
        OutlinedButton(
            onClick = {
                showTimePicker(context, startDateTime.toLocalTime()) { selectedTime ->
        ...
        OutlinedButton(
            onClick = {
                showDatePicker(context, endDateTime.toLocalDate()) { selectedDate ->
        ...
        OutlinedButton(
            onClick = {
                showTimePicker(context, endDateTime.toLocalTime()) { selectedTime ->
        ...
        Button(
            onClick = {
                ...
                val overlaps = allEntries.any { other ->
                    if (other.id == entryToEdit?.id || other.isHidden) return@any false
                    val otherStart = other.startTime
                    val otherEnd = other.endTime ?: return@any false
                    startDateTime < otherEnd && endDateTime > otherStart
                }

                if (overlaps) {
                    Toast.makeText(context, "This entry overlaps with an existing one.", Toast.LENGTH_LONG).show()
                    return@Button
                }
